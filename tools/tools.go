...
var ReadFileInputSchema = schema.GenerateAnthropicSchema[ReadFileInput]()

var ReadFileDefinition = AnthropicToolDefinition{
	Name:        "read_file",
...
var ListFilesDefinition = AnthropicToolDefinition{
	Name:        "list_files",
...
var ListFilesInputSchema = schema.GenerateAnthropicSchema[ListFilesInput]()
