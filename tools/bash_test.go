...
func TestBash_Success(t *testing.T) {
	...
	result, err := Bash(&ToolData{Input: inputJSON})
...
func TestBash_InvalidJSON(t *testing.T) {
	...
	result, err := Bash(&ToolData{Input: invalidJSON})
...
func TestBashDefinition_FunctionExecution(t *testing.T) {
	...
	result, err := BashDefinition.Function(&ToolData{Input: inputJSON})
